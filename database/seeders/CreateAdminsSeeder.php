...
class CreateAdminsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::statement("
            ...
            VALUES (5, 'e7ed7f10-7e8e-43f5-af31-ee6dfa65eb49', 'fiona', 'fiona', NULL, 'liszt.luca2@gmail.com', '$2y$10$3LYZlEfKFA4xzo84LPmtHuqDHxWIEcEeMqFNho/FXlLFFOs14aE1a', '1', NULL, NULL);
